...
public class StructuredMeshGenerator2D {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String markerLeft = "Inlet";
        String markerRight = "Outlet";
        String markerBottom = "Bottom Wall";
        String markerTop = "Top Wall";

        Geometry geom1 = new SimpleQuadGeometry(p1, p2, p3, p8);
        int numXiNodes1 = 30;
        int numEtaNodes1 = 10;
        MeshDefinition meshDefBlock1 = new MeshDefinition(geom1, numXiNodes1, numEtaNodes1, markerLeft, markerBottom, markerBottom, null);
        ...
        int numEtaNodes2 = 15;
        MeshDefinition meshDefBlock2 = new MeshDefinition(geom2, numXiNodes2, numEtaNodes2, markerLeft, null, null, markerTop);
        ...
        MeshDefinition meshDefBlock3 = new MeshDefinition(geom3, numXiNodes3, numEtaNodes3, null, markerRight, markerBottom, markerTop);
